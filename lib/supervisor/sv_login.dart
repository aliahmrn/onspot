...
import 'package:onspot_facility/supervisor/sv_homescreen.dart';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => SupervisorHomeScreen()), // Replace with your common home screen
        );
      } else {
