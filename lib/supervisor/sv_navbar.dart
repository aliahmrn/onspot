...
import 'sv_search.dart';
import 'sv_assign_task.dart';
import 'sv_history.dart';
import 'sv_profile.dart';
import 'sv_homescreen.dart';
...
class SupervisorBottomNavBar extends StatelessWidget {
  ...
  void _onItemTapped(BuildContext context, int index) {
    ...
    switch (index) {
      case 0:
        _navigateToPage(context, SupervisorHomeScreen());
        break;
      case 1:
        _navigateToPage(context, SearchPage());
        break;
      case 2:
        _navigateToPage(context, AssignTaskPage());
        break;
      case 3:
        _navigateToPage(context, HistoryPage());
        break;
      case 4:
