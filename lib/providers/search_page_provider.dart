...
class CleanersNotifier extends StateNotifier<CleanersState> {
  ...
  Future<void> fetchCleaners({String? status = 'all'}) async {
    ...
    const url = 'http://192.168.151.145:8000/api/supervisor/cleaners';
...
final cleanerDetailProvider =
  ...
  final mysqlUserNamesUrl = 'http://192.168.151.145:8000/api/user-names';
  final mysqlCleanerDetailsUrl = 'http://192.168.151.145:8000/api/supervisor/cleaner/$cleanerId';
